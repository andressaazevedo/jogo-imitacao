...
var frases = [
	{_id: 0, texto:'criando um novo repositório, crie uma nova pasta, abra-a e execute o comando', tempo: 15 },
	{_id: 1, texto:'Debuggers não consertam erros, apenas os exibem em slow motion.',tempo: 8 },
	{_id: 2, texto:'git init para criar um novo repositório..', tempo: 5 },
